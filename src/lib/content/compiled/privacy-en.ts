...
// Generated from: src/content/pages/privacy.yml
// Language: EN

import type { PageContent } from '@/types/content';

export const privacy_enContent: PageContent = {
  "meta": {
    "title": "Privacy Policy | AI Whisperers",
    "description": "Learn how we protect your privacy and handle your personal information on our AI education platform.",
    "keywords": [
      "privacy policy",
      "data protection",
...
export default privacy_enContent;
