...
// Generated from: src/content/pages/sobre-nosotros.yml

import type { PageContent } from '@/types/content';

export const sobre_nosotrosContent: PageContent = {
  "meta": {
    "title": "Sobre Nosotros - Equipo AI Whisperers | AI Whisperers",
    "description": "Conoce al equipo de AI Whisperers y nuestra misión de democratizar la educación en IA a través de cursos completos y prácticos.",
    "keywords": [
      "sobre AI Whisperers",
      "equipo educación IA",
      "misión",
...
export default sobre_nosotrosContent;
